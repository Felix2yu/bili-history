...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1.0"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/logo.ico"}],"style":[],"script":[],"noscript":[],"title":"Bilibili 历史记录管理"};
