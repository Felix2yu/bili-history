  ...
  <div class="space-y-6">
    ...
    <div v-if="viewingData" class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <div class="bg-white/50 dark:bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-gray-300/50 dark:border-gray-500/50">
        <h4 class="text-lg font-bold text-accent mb-3">最爱点赞的UP主</h4>
        <div class="space-y-2">
      ...
      <!-- 分类分布 -->
      <div class="bg-white/50 dark:bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-gray-300/50 dark:border-gray-500/50">
        <h4 class="text-lg font-bold text-accent mb-3">点赞分类分布</h4>
        <div class="space-y-2">
      ...
      <!-- 时长分布 -->
      <div class="bg-white/50 dark:bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-gray-300/50 dark:border-gray-500/50">
        <h4 class="text-lg font-bold text-accent mb-3">点赞视频时长分布</h4>
        <div class="space-y-2">
