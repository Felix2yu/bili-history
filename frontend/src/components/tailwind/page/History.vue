...
const total = ref(0)
const category = ref('')
const layout = ref(typeof window !== 'undefined' ? localStorage.getItem('defaultLayout') || 'grid' : 'grid')
const isBatchMode = ref(false)
const showRemarks = ref(props.defaultShowRemarks)
const business = ref('')
const businessLabel = ref('')
const pageSize = ref(typeof window !== 'undefined' ? parseInt(localStorage.getItem('pageSize')) || 30 : 30)
