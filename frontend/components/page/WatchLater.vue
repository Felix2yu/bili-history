                ...
                <div class="flex items-center gap-3 md:gap-4">
                  <div class="flex items-center gap-2.5">
                    <div class="flex flex-col">
                      <span class="text-[0.625rem] text-gray-500 dark:text-gray-400 uppercase tracking-wider">视频总数</span>
                      <span class="text-base md:text-lg font-bold text-gray-900 dark:text-gray-100 leading-tight">{{ videos.length }}</span>
                    </div>
                    <div class="w-px h-8 bg-gray-200 dark:bg-gray-700"></div>
                    <div class="flex flex-col">
                      <span class="text-[0.625rem] text-gray-500 dark:text-gray-400 uppercase tracking-wider">当前显示</span>
                  ...
                  <div v-if="syncing" class="flex items-center gap-1.5 text-accent px-2.5 py-1 rounded-full bg-accent/10">
                    ...
                    <span class="text-[0.6875rem] font-medium">同步中</span>
                  </div>
                </div>
              </div>
            </div>
