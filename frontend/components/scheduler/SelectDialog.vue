  ...
  <Teleport to="body">
    <Transition name="fade">
      <div v-if="show" class="fixed inset-0 z-[10000] flex items-center justify-center">
        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-[90%] max-w-lg max-h-[80vh] flex flex-col overflow-hidden">
          ...
          <div class="p-4 flex flex-col flex-1 overflow-hidden">
            <div class="mb-4 flex items-center space-x-2 flex-shrink-0">
            ...
            <div class="custom-scrollbar overflow-y-auto flex-1 pr-2">
